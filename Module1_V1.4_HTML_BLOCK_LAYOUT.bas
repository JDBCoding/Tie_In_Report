...
Private Function TIR_BuildEmailHtml(ByVal ws As Worksheet, ByVal firstRow As Long, ByVal lastRow As Long) As String
    ...
    html = ""
    html = html & "<html><body style='margin:0;padding:0;font-family:Calibri,Arial,sans-serif;font-size:11pt;color:#000000;'>"
    html = html & "<div style='width:900px;font-family:Calibri,Arial,sans-serif;font-size:11pt;color:#000000;'>"
    ...
    For r = firstRow To lastRow
        ...
        ElseIf InStr(1, UCase$(rowText), "TIE-IN REPORT SUMMARY", vbTextCompare) > 0 Then
            html = html & "<div style='text-align:center;margin-top:4px;margin-bottom:6px;font-size:14pt;font-weight:bold;color:#000000;'>"
            html = html & TIR_HtmlEncode(UCase$(rowText)) & "</div>"

        ElseIf TIR_IsLegendRow(bText, cText, dText) Then
            fontColor = TIR_GetCellColor(TIR_FirstStyledCell(ws, r))
            html = html & "<div style='text-align:center;padding:2px 0;font-size:13pt;font-weight:bold;color:" & fontColor & ";'>"
            html = html & TIR_HtmlEncode(UCase$(rowText)) & "</div>"
        ...
        ElseIf TIR_IsPomDateRow(bText, cText, dText) Then
            ...
            html = html & TIR_HtmlEncode(rowText) & "</div>"

        ElseIf TIR_IsAirplaneHeaderRow(ws, r) Then
            bgColor = TIR_GetFillColor(ws.Cells(r, "B"))
            If bgColor = "transparent" Then bgColor = "#FFFF00"
            html = html & "<div style='width:820px;margin:8px 0 8px 0;padding:4px 8px;text-align:center;font-size:16pt;font-weight:bold;text-decoration:underline;background-color:" & bgColor & ";color:#000000;'>"
            html = html & TIR_HtmlEncode(UCase$(rowText)) & "</div>"
        ...
        ElseIf TIR_IsBulletRow(bText, cText, dText) Or Left(cText, 1) = ChrW(8226) Or Left(dText, 1) = ChrW(8226) Then
            ...
            html = html & "<div style='margin-left:135px;padding:1px 0 3px 0;color:" & fontColor & ";font-weight:" & fontWeight & ";'>"
        ...
        ElseIf bText <> "" And cText = "" And dText = "" And InStr(1, bText, ":", vbTextCompare) = 0 Then
            ...
            html = html & "<div style='margin-top:8px;margin-bottom:3px;margin-left:8px;font-size:12pt;font-weight:bold;text-decoration:underline;color:" & fontColor & ";'>"
        ...
        Else
            ...
            html = html & "<div style='margin-left:45px;padding:1px 0;color:" & fontColor & ";font-weight:" & fontWeight & ";'>"
            html = html & "<span style='display:inline-block;width:95px;text-align:right;'>"
            html = html & TIR_HtmlEncode(UCase$(bText)) & "</span>"
            html = html & "<span style='padding-left:6px;'>"
            html = html & TIR_HtmlEncode(UCase$(jobText)) & "</span>"
            html = html & "</div>"
        End If
    Next r
