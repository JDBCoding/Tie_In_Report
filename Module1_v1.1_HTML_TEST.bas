...
Sub OpenEmailTieIn()
   ...
   If lastRow < 4 Then
       ...
       Exit Sub
   End If
   emailHtml = BuildSimpleTieInHtml(ws, 4, lastRow)
   On Error Resume Next
   ...
   End With
End Sub
Private Function BuildSimpleTieInHtml(ByVal ws As Worksheet, ByVal firstRow As Long, ByVal lastRow As Long) As String
   Dim html As String
   Dim r As Long
   Dim bText As String
   Dim cText As String
   ...
   html = html & "<table cellpadding='3' cellspacing='0' style='border-collapse:collapse;border:none;'>"
   For r = firstRow To lastRow
       bText = HtmlEncode(UCase$(CStr(ws.Cells(r, "B").Text)))
       cText = HtmlEncode(UCase$(CStr(ws.Cells(r, "C").Text)))
       dText = HtmlEncode(UCase$(CStr(ws.Cells(r, "D").Text)))
       html = html & "<tr>"
       html = html & "<td style='border:none;padding:4px 8px;vertical-align:top;color:" & GetCellColor(ws.Cells(r, "B")) & ";font-weight:" & GetFontWeight(ws.Cells(r, "B")) & ";background-color:" & GetFillColor(ws.Cells(r, "B")) & ";'>" & bText & "</td>"
       html = html & "<td style='border:none;padding:4px 8px;vertical-align:top;color:" & GetCellColor(ws.Cells(r, "C")) & ";font-weight:" & GetFontWeight(ws.Cells(r, "C")) & ";background-color:" & GetFillColor(ws.Cells(r, "C")) & ";'>" & cText & "</td>"
       html = html & "<td style='border:none;padding:4px 8px;vertical-align:top;color:" & GetCellColor(ws.Cells(r, "D")) & ";font-weight:" & GetFontWeight(ws.Cells(r, "D")) & ";background-color:" & GetFillColor(ws.Cells(r, "D")) & ";'>" & dText & "</td>"
       html = html & "</tr>"
   Next r
   html = html & "</table></body></html>"
   BuildSimpleTieInHtml = html
End Function
Private Function GetFontWeight(ByVal cell As Range) As String
   ...
   End If
End Function
Private Function GetCellColor(ByVal cell As Range) As String
   If cell.Font.ColorIndex = xlColorIndexAutomatic Then
       GetCellColor = "#000000"
   Else
       GetCellColor = VbaColorToHtml(cell.Font.Color)
   End If
End Function
Private Function GetFillColor(ByVal cell As Range) As String
   If cell.Interior.ColorIndex = xlColorIndexNone Then
       GetFillColor = "transparent"
   Else
       GetFillColor = VbaColorToHtml(cell.Interior.Color)
   End If
End Function
Private Function VbaColorToHtml(ByVal colorValue As Long) As String
   Dim r As Long
   Dim g As Long
   Dim b As Long
   ...
   VbaColorToHtml = "#" & Right$("0" & Hex$(r), 2) & Right$("0" & Hex$(g), 2) & Right$("0" & Hex$(b), 2)
End Function
