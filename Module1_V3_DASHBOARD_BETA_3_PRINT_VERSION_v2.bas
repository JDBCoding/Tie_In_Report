...
Private Function TIR_BuildPrintVersionHtml(ByVal ws As Worksheet, ByVal firstRow As Long, ByVal lastRow As Long) As String
    ...
    html = TIR_BuildEmailHtml(ws, firstRow, lastRow)

    html = Replace(html, "<html><body", "<html><head><meta charset='utf-8'><style>@page { size: 8.5in 11in; margin: 0.35in; } body { -webkit-print-color-adjust: exact; print-color-adjust: exact; }</style></head><body")
    html = Replace(html, "width:920px;margin:0 auto;padding:8px 0 14px 0;", "width:7.25in;margin:0 auto;padding:0;")
    html = Replace(html, "font-size:11pt;color:#202020;'><div", "font-size:11pt;color:#202020;'><div style='text-align:center;font-size:18pt;font-weight:bold;margin:0 0 8px 0;color:#222222;'>BDS FIELD TIE IN - FULL AIRCRAFT WORK LIST</div><div")
